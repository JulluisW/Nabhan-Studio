const kumpulanFilm = [
  {
    "Venom: Let There Be Carnage": {
      ...
      <br> <br>
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus impedit fuga corrupti repellat dolore quas animi quisquam libero voluptate recusandae quasi eius deserunt, aut enim tempora voluptatibus perspiciatis optio eveniet fugit nobis labore, nostrum, totam modi aperiam? Modi optio corporis distinctio earum numquam inventore similique magni, enim iure vitae. Dolorem?`,
      bioskop: [
  ...
  },
  {
    "Superman: The Movie": {
      ...
      sinopsis: "Ilmuwan Jor-El meluncurkan bayinya Kal-El, ke Bumi. Kal tumbuh menjadi Clark Kent, memiliki kemampuan tak biasa dan kekuatan untuk menjadi Superman, yang memperjuangkan kebenaran dan keadilan. <br><br>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus impedit fuga corrupti repellat dolore quas animi quisquam libero voluptate recusandae quasi eius deserunt, aut enim tempora voluptatibus perspiciatis optio eveniet fugit nobis labore, nostrum, totam modi aperiam? Modi optio corporis distinctio earum numquam inventore similique magni, enim iure vitae. Dolorem?",
      bioskop: [
        { theater: "Mall Paris Van Surabaya", jam: ["12:15", "15:20", "17:00"] },
        { theater: "Gren Indonesia", jam: ["13:15", "15:25", "17:35"] },
        { theater: "Artha Moro", jam: ["12:55", "15:00", "18:35"] },
  ...
  },
  {
    "No Time To Die": {
      ...
      sinopsis:
        "Sejenak menikmati kehidupannya setelah pensiun, Bond harus kembali beraksi demi menyelamatkan seorang teman Kali ini, Bond harus menelusuri jejak seorang penjahat misterius yang telah dipersenjatai dengan teknologi baru berbahaya.<br><br>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus impedit fuga corrupti repellat dolore quas animi quisquam libero voluptate recusandae quasi eius deserunt, aut enim tempora voluptatibus perspiciatis optio eveniet fugit nobis labore, nostrum, totam modi aperiam? Modi optio corporis distinctio earum numquam inventore similique magni, enim iure vitae. Dolorem? ",
      bioskop: [
        { theater: "Mall Paris Van Surabaya", jam: ["12:15", "15:20", "17:00"] },
        { theater: "Gren Indonesia", jam: ["13:15", "15:25", "17:35"] },
        { theater: "Artha Moro", jam: ["12:55", "15:00", "18:35"] },
  ...
  },
  {
    Kobocan: {
      ...
      sinopsis: "Kobo-chan began publication in the newspaper Yomiuri Shimbun on April 1, 1982. Beginning in December of that year, Soyosha published the series in book form. Nippon Television began airing the Kobo-chan strip on television on September 15, 1990. The weekly anime series ran on that channel from October 19, 1992, to March 21, 1994. Yomiuri had published 6,000 Kobo-chan strips by March 1999. Soyosha published Volume 60 on October 22, 2003.Houbunsha began publishing volumes on May 6, 2004. Its most recently volume, the 40th, was published on February 7, 2018.<br><br>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus impedit fuga corrupti repellat dolore quas animi quisquam libero voluptate recusandae quasi eius deserunt, aut enim tempora voluptatibus perspiciatis optio eveniet fugit nobis labore, nostrum, totam modi aperiam? Modi optio corporis distinctio earum numquam inventore similique magni, enim iure vitae. Dolorem?",
      bioskop: [
        { theater: "Mall Paris Van Surabaya", jam: ["12:15", "15:20", "17:00"] },
        { theater: "Gren Indonesia", jam: ["13:15", "15:25", "17:35"] },
...
function fungsiKursi(namaKolom) {
  ...
  if (document.getElementById(namaKolom).classList.contains("bg-light")) {
    ...
    document.getElementById("total-harga-detail").innerText = `${jumlahKursi} x Rp 50.000`;
    document.getElementById("total-harga-total").innerText = `Rp ${totalHarga}`;
  } else {
    ...
    seats[namaKolom] = 1;
    document.getElementById("total-harga-detail").innerText = `${jumlahKursi} x Rp 50.000`;
    document.getElementById("total-harga-total").innerText = ` Total: Rp ${totalHarga}`;
  }
}
...
submitSeat.addEventListener("click", function () {
  ...
  if (metodePembayaran == "Pilih") {
    ...
    document.getElementById("output-tiket-movie").innerText = `${film}`;
    document.getElementById("output-studio-tiket").innerText = `Theater : ${theater}`;
    let arrSeat = [];
    for (const key in seats) {
      arrSeat.push(key);
    }
    document.getElementById("output-seat-tiket").innerText = `Seats : ${arrSeat}`;
